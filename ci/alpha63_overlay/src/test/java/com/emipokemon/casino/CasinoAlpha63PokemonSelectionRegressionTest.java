...
final class CasinoAlpha63PokemonSelectionRegressionTest {
    ...
    @Test void alpha63IdentityIsConsistent() throws Exception {
        assertTrue(Files.readString(Path.of("gradle.properties")).contains("mod_version=0.4.0-alpha.63"));
        assertTrue(source("main/java/com/emipokemon/Emipokemon.java").contains("0.4.0-alpha.63"));
    }
}
